...
| *libbitcoin_ipc*         | IPC functionality used by *atcoin-node*, *atcoin-wallet*, *atcoin-gui* executables to communicate when [`-DWITH_MULTIPROCESS=ON`](multiprocess.md) is used.       |
