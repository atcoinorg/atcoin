...
By default, ATCOIN Core allows up to 125 connections to different peers, 11 of
...
limits are tiny. Keep in mind that atcoin's trustless model works best if you are
