...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Это ваши адреса ATCOIN для отправки платежей. Всегда проверяйте сумму и адрес получения перед отправкой монет.</translation>
    </message>
    <message>
...
Signing is only possible with addresses of the type 'legacy'.</source>
        <translation type="unfinished">Это ваши ATCOIN-адреса для приема платежей. Используйте кнопку "Создать новый адрес получения" на вкладке получения, чтобы создать новые адреса.
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Предупреждение: Если вы зашифруете кошелёк и потеряете пароль, вы &lt;b&gt;ПОТЕРЯЕТЕ ВСЕ ВАШИ ATCOINS&lt;/b&gt;!</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Помните, что шифрование кошелька не может полностью защитить ваши atcoins от кражи вредоносным ПО, заразившим ваш компьютер.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Отправить средства на ATCOIN адрес</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Подписать сообщения своими ATCOIN кошельками, что-бы доказать, что вы ими владеете</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Проверяйте сообщения, чтобы убедиться, что они подписаны конкретными ATCOIN-адресами</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Запросить платёж (генерирует QR-коды и URI протокола atcoin:)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Загрузить частично подписанную ATCOIN-транзакцию (PSBT)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Загрузить частично подписанную ATCOIN-транзакцию из буфера обмена</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Открыть URI протокола atcoin:</translation>
    </message>
    <message>
    ...
    <message numerus="yes">
        ...
        <extracomment>A substring of the tooltip.</extracomment>
        <translation type="unfinished">
            <numerusform>%n активное подключение к сети ATCOIN.</numerusform>
            <numerusform>%n активных подключения к сети ATCOIN.</numerusform>
            <numerusform>%n активных подключений к сети ATCOIN.</numerusform>
        </translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Введенный адрес "%1" не является действительным ATCOIN-адресом.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">%1 скачает и сохранит копию цепочки блоков ATCOIN.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Недавние транзакции могут быть пока не видны, и поэтому отображаемый баланс вашего кошелька может быть неточной. Информация станет точной после завершения синхронизации с сетью atcoin. Прогресс синхронизации вы можете видеть снизу.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Открыть URI atcoin</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Подключиться к сети ATCOIN через SOCKS5 прокси.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Подключаться к сети ATCOIN через отдельный SOCKS5 прокси для скрытых сервисов Tor.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Отображаемая информация может быть устаревшей. Ваш кошелёк автоматически синхронизируется с сетью ATCOIN после подключения, и этот процесс пока не завершён.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Сетевые адреса, которые ваш ATCOIN-узел использует сейчас для связи с другими узлами.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Вы можете подписывать сообщения/соглашения своими устаревшими (P2PKH) адресами, чтобы доказать, что вы можете получать atcoins на них. Будьте осторожны и не подписывайте непонятные или случайные сообщения, так как мошенники могут таким образом пытаться присвоить вашу личность. Подписывайте только такие сообщения, с которыми вы согласны вплоть до мелочей.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">%s испорчен. Попробуйте восстановить его с помощью инструмента atcoin-wallet или из резервной копии.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Ошибка: версия дамп-файла не поддерживается. Эта версия atcoin-кошелька поддерживает только дамп-файлы версии 1. Обнаружен дамп-файл версии %s</translation>
    </message>
    <message>
