...
| Name                     | Description                                                                                                                                                       |
|--------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| *libbitcoin_cli*         | RPC client functionality used by *atcoin-cli* executable                                                                                                          |
...
| *libbitcoinqt*           | GUI functionality used by *atcoin-qt* and *atcoin-gui* executables.                                                                                               |
| *libbitcoin_ipc*         | IPC functionality used by *atcoin-node*, *atcoinn-wallet*, *atcoin-gui* executables to communicate when [`-DWITH_MULTIPROCESS=ON`](multiprocess.md) is used.      |
| *libbitcoin_node*        | P2P and RPC server functionality used by *atcoind* and *atcoin-qt* executables.                                                                                   |
| *libbitcoin_util*        | Home for common functionality shared by different executables and libraries. Similar to *libbitcoin_common*, but lower-level (see [Dependencies](#dependencies)). |
| *libbitcoin_wallet*      | Wallet functionality used by *atcoind* and *atcoin-wallet* executables.                                                                                           |
| *libbitcoin_wallet_tool* | Lower-level wallet functionality used by *atcoin-wallet* executable.                                                                                              |
| *libbitcoin_zmq*         | [ZeroMQ](../zmq.md) functionality used by *atcoind* and *atcoin-qt* executables.                                                                                  |
...
atcoin-cli[atcoin-cli]-->libbitcoin_cli;

atcoind[atcoind]-->libbitcoin_node;
atcoind[atcoind]-->libbitcoin_wallet;

atcoin-qt[atcoin-qt]-->libbitcoin_node;
atcoin-qt[atcoin-qt]-->libbitcoinqt;
atcoin-qt[atcoin-qt]-->libbitcoin_wallet;

atcoin-wallet[atcoin-wallet]-->libbitcoin_wallet;
atcoin-wallet[atcoin-wallet]-->libbitcoin_wallet_tool;
...
class atcoin-qt,atcoind,atcoin-cli,atcoin-wallet bold
```
</td></tr><tr><td>
...
- *libbitcoin_common* is a home for miscellaneous shared code used by different ATCOIN Core applications. It should not depend on anything other than *libbitcoin_util*, *libbitcoin_consensus*, and *libbitcoin_crypto*.
