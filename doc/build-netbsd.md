...
This guide describes how to build atcoind, command-line utilities, and GUI on NetBSD.
...
It is not necessary to build wallet functionality to run atcoind or the GUI.

###### Descriptor Wallet Support

`sqlite3` is required to enable support for [descriptor wallets](https://github.com/atcoinorg/atcoin/blob/master/doc/descriptors.md).
...
There are many ways to configure ATCOIN Core. Here is an example that
