...
Assumeutxo is a feature that allows fast bootstrapping of a validating atcoind
instance.
...
```
$ atcoin-cli -rpcclienttimeout=0 loadtxoutset /path/to/input
```
...
```
$ atcoin-cli -rpcclienttimeout=0 dumptxoutset /path/to/output rollback
```
