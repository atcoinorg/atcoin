...
```sh
cmake --build build --target atcoind atcoin-cli
cmake --build build --target atcoin-qt
cmake --build build --target bench_atcoin
```
...
[remote "upstream-pull"]
        ...
        url = git@github.com:atcoinorg/atcoin.git
```
