...
BITCOIND=${BITCOIND:-$BINDIR/atcoind}
SHARE_EXAMPLES_DIR=${SHARE_EXAMPLES_DIR:-$TOPDIR/share/examples}
EXAMPLE_CONF_FILE=${EXAMPLE_CONF_FILE:-$SHARE_EXAMPLES_DIR/atcoin.conf}
...
##
## atcoin.conf configuration file.
## Generated by contrib/devtools/gen-atcoin-conf.sh.
##
...
# parse the output from atcoind --help
