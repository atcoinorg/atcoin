# Bootstrappable ATCOIN Core Builds

This directory contains the files necessary to perform bootstrappable ATCOIN
Core builds.
...
To build ATCOIN Core reproducibly with all default options, invoke the
...
2. The `guix-codesign` command ***requires*** a `DETACHED_SIGS_REPO` flag.
    * _**DETACHED_SIGS_REPO**_
      ...
      ATCOIN Core version being built.
