...
class MempoolLimitTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        parent_feerate = mempoolmin_feerate - Decimal("0.0000001")  # 0.01 atl/vbyte below min feerate
        # Parent + child is above mempool minimum feerate
        child_feerate = (worst_feerate_btcvb * 1000) - Decimal("0.0000001")  # 0.01 atl/vbyte below worst feerate
