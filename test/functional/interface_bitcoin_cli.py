...
WALLET_NOT_SPECIFIED = (
    ...
    "option before the command (run \"atcoin-cli -h\" for help or \"atcoin-cli listwallets\" to see "
...
class TestBitcoinCli(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `atcoin-cli getblockchaininfo`")
        ...
        # Prevent atcoin-cli from using existing rpcport in conf
        ...
        self.log.info("Test -getinfo and atcoin-cli return all proxies")
        ...
        if self.is_specified_wallet_compiled():
            self.log.info("Test -getinfo and atcoin-cli getwalletinfo return expected wallet info")
            ...
            # Test atcoin-cli -generate with -rpcwallet in multiwallet mode.
